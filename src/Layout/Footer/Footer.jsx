        ...
        <footer className="footer">
            <div className="footer__top">
                    ...
                    <form className="footer__form">
                        <input type="text" className="footer__form-input" required/>
                    ...
                    <ul className="footer__list">
                        ...
                        <li className="footer__item">
                            <Link className="footer__link" to='PopularQuestions'>Распространенные вопросы</Link>
                        </li>
                        <li className="footer__item">
            ...
            <div className="container">
                <div className="footer__bottom">
                    ...
                    <p className="footer__text">Дизайн и разработка: Сатыбалдиев Айдар Б.</p>
                </div>
            </div>
